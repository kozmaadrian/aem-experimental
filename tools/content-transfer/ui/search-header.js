...
const EL_NAME = 'transfer-source-header';

class TransferSourceHeader extends LitElement {
  static properties = {
    org: { type: String },
    site: { type: String },
  ...
  dispatchField(field, event) {
    this.dispatchEvent(new CustomEvent('transfer-source-field-change', {
  ...
  handleSubmit(event) {
    ...
    this.dispatchEvent(new CustomEvent('transfer-source-search', {
      bubbles: true,
      composed: true,
    }));
  }
  ...
  render() {
    return html`
      <div class="header-inner">
        ...
        >
          <label class="search-bar__field" for="transfer-source-org">
            <span class="field-label">Organization</span>
            <input
              type="text"
              id="transfer-source-org"
              class="field"
          ...
          <label class="search-bar__field" for="transfer-source-site">
            <span class="field-label">Site</span>
            <input
              type="text"
              id="transfer-source-site"
              class="field"
              placeholder="Site"
              .value=${this.site}
          ...
          <label class="search-bar__field" for="transfer-source-term">
...
if (!customElements.get(EL_NAME)) customElements.define(EL_NAME, TransferSourceHeader);
